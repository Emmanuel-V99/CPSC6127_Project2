...
hdfs dfs -put "C:/Users/the6t/OneDrive/Desktop/Spring Semester 2025/CPSC 6127 Contemporary Issues in Database Management Systems/Project 2/CPSC6127_Project2/data/cleaned_emails.txt" /emmanuel/
